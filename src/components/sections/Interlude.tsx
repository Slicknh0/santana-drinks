  ...
  return (
    <section aria-labelledby="interlude-title" className="relative isolate">
      <LitImage
        ...
        sizes="100vw"
        className="h-[82svh] min-h-[30rem] w-full"
        imageClassName="object-cover object-[50%_58%]"
      />
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(to_bottom,var(--color-asphalt),rgb(14_13_10/0)_24%,rgb(14_13_10/0)_58%,var(--color-asphalt))]" />
