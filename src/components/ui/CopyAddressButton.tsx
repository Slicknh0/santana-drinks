  ...
  return (
    <div className="flex flex-col gap-1">
      <button
        type="button"
        onClick={handleCopy}
        className="inline-flex min-h-11 items-center gap-2.5 self-start text-sm text-dust transition-colors duration-300 hover:text-chalk active:translate-y-px"
      >
