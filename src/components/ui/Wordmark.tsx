...
export function Wordmark({ variant = "compact" }: WordmarkProps) {
  if (variant === "hero") {
    return (
      <span translate="no" className="flex flex-col items-start gap-4 md:flex-row md:items-end md:gap-7">
  ...
  return (
    <span translate="no" className="inline-flex items-center gap-2.5">
